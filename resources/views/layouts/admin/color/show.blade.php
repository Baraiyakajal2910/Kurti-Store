    ...
    <div class="col-12">
        <div class="card-box table-responsive ">
            ...
            <div class="text-right mb-3">
                <a href="{{ url('admin/color/add')}}" class="btn btn-primary waves-effect waves-light btn-sm">
                <i class="fa fa-plus-square"></i> Add
                </a>
                <a href="{{ url('admin/color/trash')}}" class="btn btn-danger waves-effect waves-light btn-sm">
            ...
            <table id="datatable" class="table table-bordered">
                ...
                <tr>
                    ...
                    <td><div><a href="{{ url('admin/color/showEditForm',$data->id)}}" class="btn btn-info">Edit</a>
                       <!--  <form class="d-inline" action="{{ url('update/color',$data->id) }}" ><input type="submit" name="delete" value="Delete"  class="btn btn-danger"></form> -->
                        <a href="{{ url('admin/color/update',$data->id)}}" class="btn btn-danger">Delete</a></div>
                    </td>
                </tr>
                @endforeach
                </tbody>
