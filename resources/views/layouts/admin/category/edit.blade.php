...
<!-- end row -->
	<div class="row">
        <div class="col-lg-12">
			<form action="{{ url('admin/categories/edit',$category->id)}}" method="POST" name="Add_category">
				@csrf
				<div class="card-box">
                    ...
                    <div class="form-group">
                        <label>Category Name</label>
                            ...
                            <input type="text" name="name" id="name" parsley-trigger="change"
                                placeholder="Enter category name" value="{{ $category->name }}" class="form-control" class="@error('name') is-invalid @enderror">
                            @error('name')
